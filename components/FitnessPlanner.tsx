    ...
    <div className="p-4 space-y-8 pb-32 max-w-lg mx-auto">
      <div className="flex flex-col items-center gap-4 pt-10">
        ...
        <div className="text-center space-y-1">
          <h2 className="text-3xl font-black text-slate-800 dark:text-white tracking-tight">Routine</h2>
          <p className="text-[10px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.3em]">Weekly Performance Map</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        {(plan[activeDay] || []).length > 0 ? plan[activeDay].map(ex => (
          <div key={ex.id} className="bg-white dark:bg-slate-900 p-8 rounded-[40px] shadow-sm border border-slate-100 dark:border-slate-800 space-y-8 group hover:shadow-xl transition-all animate-in slide-in-from-bottom-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-3">
                <label className="text-[9px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.2em] pl-1">Sets</label>
              ...
              <div className="space-y-3">
                <label className="text-[9px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.2em] pl-1">Reps</label>
                <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-2 border dark:border-slate-800">
          ...
          <div className="py-20 text-center space-y-4 bg-white/50 dark:bg-slate-900/50 rounded-[40px] border-2 border-dashed border-slate-100 dark:border-slate-800">
            <div className="text-slate-300 dark:text-slate-700 mx-auto w-fit"><Dumbbell size={48} /></div>
            <div className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em]">Rest Day or No Plan</div>
          </div>
        )}
